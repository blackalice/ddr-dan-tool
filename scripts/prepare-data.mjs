...
const tasks = [
  ...
  {
    id: 'a3-override',
    command: 'generate-ddr-a3-override.mjs',
    inputs: [{ file: rel('__MUSICDB', 'musicdbA3.xml') }],
    sources: scripts('generate-ddr-a3-override.mjs', 'cache-utils.mjs'),
    outputs: files('data/ddr-ver/DDRA3-full.json'),
  },
  {
    id: 'sm-list',
  ...
  {
    id: 'ddr-version-overrides',
    command: 'generate-ddr-version-overrides.mjs',
    deps: ['song-meta'],
    inputs: [
      { file: rel('data', 'generated', 'song-meta.json') },
      { tree: rel('data', 'remywiki', 'songlists'), match: /\.html?$/i },
      { tree: rel('data', 'remywiki', 'game-pages'), match: /\.html?$/i },
    ],
    sources: [
      ...scripts('generate-ddr-version-overrides.mjs', 'cache-utils.mjs'),
      ...files('src/utils/stringSimilarity.js'),
    ],
    outputs: files(
      'data/ddr-ver/DDR-full.json',
      'data/ddr-ver/DDR2ND-full.json',
      'data/ddr-ver/DDR3RD-full.json',
      'data/ddr-ver/DDR4TH-full.json',
      'data/ddr-ver/DDR4THPLUS-full.json',
      'data/ddr-ver/DDR5TH-full.json',
      'data/ddr-ver/DDR6TH-full.json',
      'data/ddr-ver/DDR7TH-full.json',
      'data/ddr-ver/DDREX-full.json',
      'data/ddr-ver/DDRSN1-full.json',
      'data/ddr-ver/DDRSN2-full.json',
      'data/ddr-ver/DDRX-full.json',
      'data/ddr-ver/DDRX2-full.json',
      'data/ddr-ver/DDRX3VS2ND-full.json',
      'data/ddr-ver/DDR2013-full.json',
      'data/ddr-ver/DDR2014-full.json',
      'data/ddr-ver/DDRA-full.json',
      'data/ddr-ver/DDRA20-full.json',
      'data/ddr-ver/DDRA20PLUS-generated-full.json',
      'data/ddr-ver/DDRA3-generated-full.json',
      'data/ddr-ver/DDRWORLD-full.json',
    ),
  },
  {
    id: 'public-sync',
    command: 'sync-public-assets.mjs',
    deps: ['a3-override', 'processed-data', 'world-challenges', 'ddr-version-overrides'],
    alwaysRun: true,
    inputs: [],
